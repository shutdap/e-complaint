    ...
    <section id="page-title">
        ...
        <div class="container clearfix">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="inboxadmin.php">Complaint Masuk</a></li>
                        ...
                        <table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            if($status == 1){ /*Ini buat admin*/
                                ...
                                elseif ($tampil['status'] == 4 && $tampil['lingkupkel'] == 'Fasilitas') {
                                    $say = "Sedang Ditangani oleh Teknisi";
                                }
                                 elseif ($tampil['status'] == 4 && $tampil['lingkupkel'] == 'Akademik') {
                                    $say = "Sedang Ditangani oleh Dosen yang Bersangkutan";
                                }
                                else {
                                ...
                                elseif ($tampil['status'] == 4 && $tampil['lingkupkel'] == 'Fasilitas') {
                                    $say = "Sedang Diproses Oleh Teknisi Yang Bersangkutan";
                                }
                                 elseif ($tampil['status'] == 4 && $tampil['lingkupkel'] == 'Akademik') {
                                    $say = "Sedang Di Proses Oleh Dosen Yang Bersangkutan";
                                }
                                else {
                                    $say = "Selesai Di Tangani";
                                }
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $say; ?> </td>
                                    <td>
                                        <a href="printdiprosesadmin.php?id=<?php echo $tampil['id']; ?>">Baca</a></a>
                                        &nbsp;&nbsp;&nbsp;
                                     <a href="print_log3.php?id=<?php echo $tampil['angka_random']; ?>">Log</a></td>
                                    </td>
                                </tr>
                            <?php };?>
                            </tbody>
