...
$id = $_GET['id'];
$sql = mysqli_query($con, "SELECT a.*, b.`kondisi` FROM `data_complaint` AS a LEFT JOIN `status` AS b ON a.`status` = b.`status` where a.`angka_random`='$id'");
            ...
            <div class="container clearfix">
                <div class="heading-block center">
                    ...
                    <span>Fakultas Teknologi Informasi | Universitas Serang Raya</span>
                     ...
                     <?php
                    $id = $_GET['id'];
                    $sql1 = mysqli_query($con, "SELECT * FROM `data_complaint` where `angka_random`='$id'");
                    ...
                    <table class="table table-hover">
                       ...
                       <tr>
                            ...
                            <td colspan="7" class="<?php echo $class; ?>">
                                Complaint Anda Saat Ini <strong> <?php echo $status; ?> || <a href="print_log.php?id=<?php echo $tampil['angka_random']; ?>">Log</a></a> <input type="text" style="display: none" name="statusp" value="<?php echo $status_asli; ?>">
                                </strong>
                            </td>
                        </tr>
                        </tbody>
