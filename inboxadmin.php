    ...
    <section id="page-title">
        ...
        <div class="container clearfix">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="diprosesadmin.php">Complaint Diproses</a></li>
                    ...
                    <div class="table-responsive">
                        <table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            if ($status == 1) {
                                ...
                                $sql = "SELECT * FROM `data_complaint` WHERE `lingkupkel` = 'Akademik' AND `status` = 2 ORDER BY `id` DESC";
                           ...
                           if($status == 1){
                                ...
                                if($tampil['status'] = 2)
                                    $say = "Sedang Dialihkan pada Bagian Fasilitas";
                                elseif ($tampil['status'] = 3)
