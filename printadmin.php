        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <form method="post" action="prosesupdateadmin.php"> 
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="angka_random" value="<?php echo $random; ?>" readonly/>
                        ...
                        <select id="lingkupkel" name="lingkupkel" class="form-control" style="width: 100%;">
                            ...
                            <option value="Akademik" <?php if($tipe=="Akademik"){echo $selected;} ?>>Akademik</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $random; ?><input type="text" name="angka" style="display: none" value="<?php echo $random; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <a class="button button-3d button-black nomargin fright" href="inbox.php?nim=$nim">Back</a>
