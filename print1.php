        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <div class="col_full">
                    <table class="table table-hover">
                       ...
                       <tr>
                            ...
                            <td colspan="7" class="<?php echo $class; ?>">
                                Complaint Anda Saat Ini <strong> <?php echo $status; ?> || <a href="print_log1.php?id=<?php echo $tampil['angka_random']; ?>">Log</a></a> <input type="text" style="display: none" name="statusp" value="<?php echo $status_asli; ?>">
                                </strong>
                            </td>
                        </tr>
                        </tbody>
                 ...
                 <div class="col_full">
                    <a class="button button-3d button-black nomargin fright" href="diproses.php">Back</a>
                </div>
