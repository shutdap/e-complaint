    ...
    <section id="page-title">
        ...
        <div class="container clearfix">
            ...
            <ol class="breadcrumb">
                ...
                <li class ="active">Data Complaint</a></li>
                ...
                <div class="col_full">
                    <div class="table-responsive">
                        <table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            $sql = "SELECT * FROM `data_complaint` ORDER BY `id` DESC";    
                            ...
                            while($tampil = mysqli_fetch_array($query)){
                                ...
                                <tr>
                                    ...
                                    if ($tampil['status'] == 1 ) {
                                        $class = "danger";
                                    } elseif ($tampil['status'] == 2 || $tampil['status'] == 3 || $tampil['status'] == 4){
                                        $class = "warning";
                                    } else {
                                        $class = "success";
                                    }
                                    ?>
                                    <td class="<?php echo $class; ?>"><?php echo $say; ?> </td>
                                    <td>
                                        <a href="print_complaint.php?id=<?php echo $tampil['id']; ?>">Baca</a></a>
                                        &nbsp;&nbsp;&nbsp;
                                     <a href="print_log_complaint.php?id=<?php echo $tampil['angka_random']; ?>">Log</a></td>
                                </tr>
                            <?php }; ?>
                            </tbody>
                        </table>
