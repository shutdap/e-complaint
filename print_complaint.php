                ...
                <div class="col_full">
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td colspan="2">
                                <?php
                                if (($row['gambar_dari_admin'] == '-') || ($row['gambar_dari_admin'] == '')) {
                                    echo "<div align='center'><strong>Lampiran tidak Tersedia</strong></div>";
                                } else {
                       ...
                       <tr>
                            ...
                            <td colspan="7" class="<?php echo $class; ?>">
                                Complaint Anda Saat Ini <strong> <?php echo $status; ?> || <a href="print_log_complaint.php?id=<?php echo $tampil['angka_random']; ?>">Log</a></a> <input type="text" style="display: none" name="statusp" value="<?php echo $status_asli; ?>">
                                </strong>
                            </td>
                        </tr>
                        </tbody>
                 ...
                 <div class="col_full">
                    <a class="button button-3d button-black nomargin fright" href="list_complaint.php">Back</a>
                </div>
