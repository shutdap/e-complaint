...
<div id="wrapper" class="clearfix">
                ...
                <nav id="primary-menu">
                    ...
                    <ul>
                        ...
                        if (!empty($_SESSION['nim'])){
                            ...
                            $sql_nav = mysqli_query($con, "SELECT * FROM `menu` WHERE `status` IN ('$status', '99')");
    ...
    <section id="slider" class="force-full-screen full-screen">
        ...
        <div class="force-full-screen full-screen dark" style="background-image: url('images/bw.jpg');background-position: 50% 0;">
